...
p_states <- p +
  geom_text(data = state_clinton_targets, mapping=aes(x=date, y = result-value, color = variable, label=state_abb), size=5) +
  geom_line(data = state_clinton_targets, mapping=aes(x=date, y = result-value, color = variable, label=state_abb), alpha = 0.5) +
  geom_text(data = state_clinton_targets, mapping=aes(x=date, y = value-result, color = variable, label=state_abb), size=5) +
  geom_line(data = state_clinton_targets, mapping=aes(x=date, y = value-result, color = variable, label=state_abb), alpha = 0.5) +
